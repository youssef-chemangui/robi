...
/**
 * Construit l'environnement côté serveur (pour le rendu de comparaison).
 * Identique à l'environnement de l'exercice 5/6.
 */
public class ServerEnvironmentFactory {

    public static exercice5.Environment create() {
        GSpace space = new GSpace("Serveur — rendu comparaison", new Dimension(300, 200));
        space.open();
        ...
        exercice5.Environment env = new exercice5.Environment();
